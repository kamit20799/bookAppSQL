...
#created a new database of name: bookstore1
use bookstore1;													
#it specifies the file

create table authors1(											
#creates a new table, it has 3 columns: authors_id, authors_name, authors_email
...
# 'insert into' means insert new item in the records
...
#foreign key is a field, that refers the primary key to the another table
);

insert into books1 values										
# data inserted into the 'books1' table
...
# data inserted into the 'customers1' table
...
# data inserted into the 'favourites1' table
